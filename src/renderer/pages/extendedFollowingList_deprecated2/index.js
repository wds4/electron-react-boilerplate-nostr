...
export default class ExtendedFollowerList extends React.Component {
    ...
    handleLevel0Callback = (aFollowing0) =>{
        console.log("control panel page; aFollowing0: "+aFollowing0)
        var pubkeys_new = this.state.pubkeys
        pubkeys_new.aFollowing0 = aFollowing0
                ...
                <div id="mainCol" >
                    ...
                    <div id="mainPanel" >
                        ...
                        <Fetch1DegreeFollowingList
                            seed={this.state.pubkeys.seed}
                            level0Callback = {this.handleLevel0Callback}
